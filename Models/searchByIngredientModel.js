...
ingredient.query = (ingredient) => {
    ...
    return new Promise((resolve, reject) => {
        sql.query('SELECT r.aggregatedRating, r.recipeName, r.image, r.description, r.instructions , r.authorID, a.authorName, i.ingredientName, \
        i.ingredientQty from recipe r INNER JOIN ingredient i ON r.recipeID = i.ingredientID  INNER JOIN author a ON r.authorID = a.authorID\
